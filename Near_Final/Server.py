...
def parallel(year, state):
    ...
    fieldnames = ("state", "year", "victim sex", "victim age", "victim race", "relationship", "perpetrator race", "perpetrator age", "perpetrator sex", "crime solved")
    ...
    for row in reader:
        if row['state'] == state and row['year'] == year:
            ...
            data['crime solved'] = row['crime solved']
            list.append(data)
